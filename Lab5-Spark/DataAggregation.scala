...
//for groups
val resultsForGroupsPom= data.map(t=>(t._1,(1,t._2,t._2*t._2))).reduceByKey((a,b)=>(a._1+b._1,a._2+b._2,a._3+b._3))
resultsForGroupsPom.cache


// group , (number of examples, average, variance)
val resultsForGroups=resultsForGroupsPom.map(p=>(p._1,(p._2._1,(p._2._2/p._2._1),(p._2._3/p._2._1)-(p._2._2/p._2._1)*(p._2._2/p._2._1))))

resultsForGroups.collect().foreach(println)

//for all
//(0,(number of examples, sum, sum*sum))
val dataAll =resultsForGroupsPom.reduce((a,b) =>(0,(a._2._1+b._2._1, a._2._2+b._2._2, a._2._3+b._2._3)))
