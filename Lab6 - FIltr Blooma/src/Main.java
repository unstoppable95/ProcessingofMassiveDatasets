...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double factor = 20;
        int size = (int) Math.round(factor * n); //size of filter
        int k = 5; // number of hash functions

        Random random = new Random(0);
        BloomFilter bloomFilter = new BloomFilter(size, k,n,range);
        ...
        System.out.println("Expected FPR = " + String.format("%1.6f", Math.pow(1 - Math.exp(-k * (double)n/ size), k)));
